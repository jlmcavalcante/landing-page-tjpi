...
export const diasData: Dia[] = [
  ...
  },
  {
    ...
    palestras: [
      ...
      {
        horario: '18:30',
        titulo: 'Encerramento com Apresentação do Projeto Vencedor e Assinatura do Termo de Cooperação minutado na Oficina',
        palestrante: '',
        participantes: [],
      },
    ],
